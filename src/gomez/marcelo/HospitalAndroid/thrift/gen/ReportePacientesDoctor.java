...
public class ReportePacientesDoctor implements org.apache.thrift.TBase<ReportePacientesDoctor, ReportePacientesDoctor._Fields>, java.io.Serializable, Cloneable, Comparable<ReportePacientesDoctor> {
  ...
  static {
    schemes.put(StandardScheme.class, new ReportePacientesDoctorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReportePacientesDoctorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReportePacientesDoctor.class, metaDataMap);
  }
   ...
   */
  public ReportePacientesDoctor(ReportePacientesDoctor other) {
  ...
  public ReportePacientesDoctor deepCopy() {
    return new ReportePacientesDoctor(this);
  }
  ...
  public ReportePacientesDoctor setClavePaciente(String clavePaciente) {
    this.clavePaciente = clavePaciente;
    return this;
  }
  ...
  public ReportePacientesDoctor setClaveDoctor(String claveDoctor) {
    this.claveDoctor = claveDoctor;
    return this;
  }
  ...
  public ReportePacientesDoctor setNombrePaciente(String nombrePaciente) {
    this.nombrePaciente = nombrePaciente;
    return this;
  }
  ...
  public ReportePacientesDoctor setNombreDoctor(String nombreDoctor) {
    this.nombreDoctor = nombreDoctor;
    return this;
  }
  ...
  public ReportePacientesDoctor setTratamiento(String tratamiento) {
    this.tratamiento = tratamiento;
    return this;
  }
  ...
  public ReportePacientesDoctor setDiagnostico(String diagnostico) {
    this.diagnostico = diagnostico;
    return this;
  }
  ...
  public ReportePacientesDoctor setFecha(String fecha) {
    this.fecha = fecha;
    return this;
  }
  ...
  public ReportePacientesDoctor setFotoDoctor(String fotoDoctor) {
    this.fotoDoctor = fotoDoctor;
    return this;
  }
  ...
  public ReportePacientesDoctor setFotoPaciente(String fotoPaciente) {
    this.fotoPaciente = fotoPaciente;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReportePacientesDoctor)
      return this.equals((ReportePacientesDoctor)that);
    return false;
  }

  public boolean equals(ReportePacientesDoctor that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReportePacientesDoctor other) {
  ...
  private static class ReportePacientesDoctorStandardSchemeFactory implements SchemeFactory {
    public ReportePacientesDoctorStandardScheme getScheme() {
      return new ReportePacientesDoctorStandardScheme();
    }
  }

  private static class ReportePacientesDoctorStandardScheme extends StandardScheme<ReportePacientesDoctor> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReportePacientesDoctor struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReportePacientesDoctor struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReportePacientesDoctorTupleSchemeFactory implements SchemeFactory {
    public ReportePacientesDoctorTupleScheme getScheme() {
      return new ReportePacientesDoctorTupleScheme();
    }
  }

  private static class ReportePacientesDoctorTupleScheme extends TupleScheme<ReportePacientesDoctor> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReportePacientesDoctor struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReportePacientesDoctor struct) throws org.apache.thrift.TException {
