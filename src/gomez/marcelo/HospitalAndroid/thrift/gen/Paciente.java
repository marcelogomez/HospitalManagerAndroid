...
public class Paciente implements org.apache.thrift.TBase<Paciente, Paciente._Fields>, java.io.Serializable, Cloneable, Comparable<Paciente> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Paciente");
  ...
  private static final org.apache.thrift.protocol.TField TELEFONO_FIELD_DESC = new org.apache.thrift.protocol.TField("telefono", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new PacienteStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PacienteTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Paciente.class, metaDataMap);
  }
   ...
   */
  public Paciente(Paciente other) {
    if (other.isSetClave()) {
  ...
  public Paciente setClave(String clave) {
    this.clave = clave;
    return this;
  }
  ...
  public Paciente setFoto(String foto) {
    this.foto = foto;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Paciente)
      return this.equals((Paciente)that);
    return false;
  }

  public boolean equals(Paciente that) {
    if (that == null)
      return false;
  ...
  private static class PacienteStandardSchemeFactory implements SchemeFactory {
    public PacienteStandardScheme getScheme() {
      return new PacienteStandardScheme();
    }
  }

  private static class PacienteStandardScheme extends StandardScheme<Paciente> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Paciente struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Paciente struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PacienteTupleSchemeFactory implements SchemeFactory {
    public PacienteTupleScheme getScheme() {
      return new PacienteTupleScheme();
    }
  }

  private static class PacienteTupleScheme extends TupleScheme<Paciente> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Paciente struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Paciente struct) throws org.apache.thrift.TException {
